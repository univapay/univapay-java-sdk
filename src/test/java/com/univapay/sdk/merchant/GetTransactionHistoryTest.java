...
public class GetTransactionHistoryTest extends GenericTest {
  ...
  @Test
  public void shouldRequestAndReturnTransactionHistory()
    ...
    assertEquals(firstTransaction.getStoreId().toString(), "45facc11-efc8-4156-8ef3-e363a70a54c3");
    assertEquals(
        firstTransaction.getResourceId().toString(), "e1771339-b989-4a43-99c1-5e35d8008426");
    assertEquals(
        secondTransaction.getResourceId().toString(), "bae4fd94-aace-437c-bf63-8908008dff81");
    assertEquals(
        thirdTransaction.getResourceId().toString(), "6da25a85-754c-41db-97ec-c2e50f7591d5");
    ...
    assertThat(
        ...
        is("CARD HOLDER0"));
    assertThat(
        firstTransaction.getUserData().asCardTransactionData().getGateway(), is(nullValue()));
    ...
    assertThat(
        ...
        is(Konbini.LAWSON));
    assertThat(
        secondTransaction.getUserData().asKonbiniTransactionData().getGateway(), is(nullValue()));
    ...
    assertThat(
        ...
        is("CARD HOLDER4"));
    assertThat(
        response.getItems().get(4).getUserData().asApplePayTransactionData().getGateway(),
        is(nullValue()));
  }
